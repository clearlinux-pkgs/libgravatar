...
Source0  : https://download.kde.org/stable/release-service/22.12.1/src/libgravatar-22.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.1/src/libgravatar-22.12.1.tar.xz.sig
...
%prep
%setup -q -n libgravatar-22.12.1
cd %{_builddir}/libgravatar-22.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673385407
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Gravatar.so.5.22.1
...
/usr/share/package-licenses/libgravatar/c011fda7746c087a127999da1c4044854ee42238
