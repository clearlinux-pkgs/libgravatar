...
Source0  : https://download.kde.org/stable/release-service/22.08.1/src/libgravatar-22.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.1/src/libgravatar-22.08.1.tar.xz.sig
...
%prep
%setup -q -n libgravatar-22.08.1
cd %{_builddir}/libgravatar-22.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662785081
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Gravatar.so.5.21.1
